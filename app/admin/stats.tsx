...
export default function AdminStatsScreen() {
  ...
  return (
    ...
    >
      ...
      <SectionTitle icon="stats-chart" title="Indicateurs clés" />
      ...
      {/* SECTION — RESTAURANT LE MIEUX NOTÉ */}
      ...
      {/* SECTION — RESTAURANT LE MOINS BIEN NOTÉ */}
      <SectionTitle icon="sad" title="Restaurant le moins noté" />
      {stats.pire ? (
      ...
      {/* SECTION — GRAPHIQUE SIMPLE (barres horizontales) */}
